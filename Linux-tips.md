...
具体实践见 [磁盘问题](./Unix-tips.assets/磁盘问题.md)
...
sudo apt install -y git vim zsh curl wget ffmpeg tmux cmake tree net-tools pandoc nodejs npm zoxide fzf ninja-build nginx qpdf
